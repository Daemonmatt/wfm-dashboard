...
export default function FileUpload({ onFileLoaded, isLoading, fileName, progress }: FileUploadProps) {
  ...
  return (
    <div className="space-y-1">
          ...
          {isLoading ? (
            <>
              ...
              <span className="text-slate-500">
                ...
                {fileSize && fileSize > 10 * 1024 * 1024 && (
                  <span className="text-slate-400 ml-1">({formatFileSize(fileSize)} file)</span>
                )}
              </span>
            </>
          ) : fileName ? (
            ...
            <>
              ...
              <span className="text-slate-500 dark:text-slate-400">
                ...
                <span className="text-slate-400 ml-1">(supports large files up to 100MB)</span>
              </span>
            </>
          )}
        </div>
      ...
      {isLoading && progress && progress.phase !== "reading" && (
        <div className="px-1">
          <div className="h-1.5 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-blue-500 to-teal-500 transition-all duration-200 ease-out"
